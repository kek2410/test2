...
const namespace = "app-menu-manage";

@Component({})
export default class AppMenuManage extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() appMenuManage !: any;
  @Getter("appMenuManage") getAppMenuManage!: any;
  @Action("appMenuManage", { namespace }) actAppMenuManage !: any;
