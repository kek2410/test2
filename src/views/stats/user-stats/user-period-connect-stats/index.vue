...
const namespace = "user-period-connect-stats";

@Component({})
export default class UserPeriodConnectStats extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() userPeriodConnectStats !: any;
  @Getter("userPeriodConnectStats") getUserPeriodConnectStats!: any;
  @Action("userPeriodConnectStats", { namespace }) actUserPeriodConnectStats !: any;
