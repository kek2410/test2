...
const namespace = "user-period-sign-stats";

@Component({})
export default class UserPeriodSignStats extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() userPeriodSignStats !: any;
  @Getter("userPeriodSignStats") getUserPeriodSignStats!: any;
  @Action("userPeriodSignStats", { namespace }) actUserPeriodSignStats !: any;
