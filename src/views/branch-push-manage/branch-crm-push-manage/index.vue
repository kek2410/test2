...
const namespace = "branch-crm-push-manage";

@Component({})
export default class BranchCrmPushManage extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() branchCrmPushManage !: any;
  @Getter("branchCrmPushManage") getBranchCrmPushManage!: any;
  @Action("branchCrmPushManage", { namespace }) actBranchCrmPushManage !: any;
