...
const namespace = "branch-event-manage";

@Component({})
export default class BranchEventManage extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() branchEventManage !: any;
  @Getter("branchEventManage") getBranchEventManage!: any;
  @Action("branchEventManage", { namespace }) actBranchEventManage !: any;
