...
const namespace = "crm-push-manage";

@Component({})
export default class CrmPushManage extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() crmPushManage!: any;
  @Getter("crmPushManage") getCrmPushManage!: any;
  @Action("crmPushManage", { namespace }) actCrmPushManage!: any;
