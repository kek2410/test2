...
const namespace = "coupon-push-list";

@Component({})
export default class CouponPushList extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() couponPushList !: any;
  @Getter("couponPushList") getCouponPushList!: any;
  @Action("couponPushList", { namespace }) actCouponPushList !: any;
