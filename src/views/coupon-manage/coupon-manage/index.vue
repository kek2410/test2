...
const namespace = "coupon_manage";

@Component({})
export default class CouponManage extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() couponManage!: any;
  @Getter("couponManage") getCouponManage!: any;
  @Action("couponManage", { namespace }) actCouponManage!: any;
