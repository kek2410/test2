...
const namespace = "coupon_manage_member";

@Component({})
export default class CouponManageMember extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() couponManageMember!: any;
  @Getter("couponManageMember") getCouponManageMember!: any;
  @Action("couponManageMember", { namespace }) actCouponManageMember!: any;
