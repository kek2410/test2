...
const namespace = "coupon_book_manage";

@Component({})
export default class CouponBookManage extends Vue {
  //프로퍼티 필요시 사용.
  @Prop() couponBookManage!: any;
  @Getter("couponBookManage") getCouponBookManage!: any;
  @Action("couponBookManage", { namespace }) actCouponBookManage!: any;
