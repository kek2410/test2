<template>
  <v-app id="inspire">
    ...
    <Header :drawer="drawer" @fnDraw="fnDraw" />
...
import Navigation from "@/layout/main/components/Navigation.vue";
import Header from "@/layout/main/components/Header.vue";
import Footer from "@/layout/main/components/Footer.vue";
import Progress from "@/layout/main/components/Progress.vue";
